...
const Banner = () => {
    ...
    return (
        <div className='relative mx-2 lg:mx-0 '>
            <div className='bg-primary-color text-white mt-2 md:m-5 lg:m-7 rounded-2xl pb-64'>
                <div>{pathname === '/' && <NavBar></NavBar>}</div>
                <div className='text-center pt-4'>
                    <h1 className='font-bold text-2xl md:text-[40px] md:leading-[40px] lg:text-[56px] lg:leading-[56px]'>Upgrade Your Tech Accessorize with <br /> Gadget Heaven Accessories</h1>
            ...
            <div className='max-w-6xl p-2 md:p-4  lg:p-6 bg-[#ffffff70] border-2 border-white rounded-2xl relative bottom-[230px] mx-auto'>
